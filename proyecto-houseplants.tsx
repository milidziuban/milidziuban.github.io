        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-4">
            {tools.map((tool, i) => (
              ...
              >
                <span className="font-instrument-serif italic text-2xl text-brand-lite block mb-3">
                  0{i + 1}
                </span>
                <h3 className="text-base font-medium font-space-grotesk text-ink mb-3">
                  {tool.title}
                </h3>
                <p className="text-ink-2 text-sm font-manrope leading-relaxed">
                  {tool.text}
                </p>
              </motion.div>
            ))}
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <ScrollReveal direction="right" delay={0.2}>
              <div>
                ...
                <p className="text-ink-2 font-manrope leading-relaxed">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <ScrollReveal direction="left">
              <div>
                ...
                <p className="text-ink-3 font-manrope mb-8">
                  El arquetipo que guió las decisiones
                </p>

                <div className="bg-white border border-hairline rounded-2xl p-8 space-y-4">
                  <p className="text-2xl font-medium text-ink font-space-grotesk">
                    Paula
                  </p>
                  <ul className="space-y-3 text-ink-2 font-manrope">
                    {[
                      { label: "Contexto", value: "32 años. Vive en un departamento en la ciudad" },
                      { label: "Trabajo", value: "Modalidad híbrida, pasa mucho tiempo en casa" },
                      { label: "Plantas", value: "Tiene varias, con poca experiencia en jardinería" },
                    ].map((item) => (
                      <li key={item.label} className="grid gap-0.5">
                        <span className="font-meta text-[11px] uppercase text-ink-3">
                          {item.label}
                        </span>
                  ...
                  <div className="pt-4 space-y-3 border-t border-hairline">
                    <p className="font-instrument-serif italic text-ink-2">
                ...
                <p className="text-ink-2 font-manrope leading-relaxed mt-6">
