      ...
      >
        <div className="flex items-center space-x-8">
            ...
            {navigationItems.map((item) => {
              ...
              return (
                <div key={item.name} className="relative">
                  ...
                  {isActive && (
                    <motion.div
                      className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 w-1.5 h-1.5 bg-gray-50 rounded-full"
          ...
          >
            ...
            >
              <Button className="bg-purple-800 hover:bg-purple-600 text-white px-6 py-2 font-medium rounded-[32px]">
                Descargar CV
              </Button>
            </a>
          </motion.div>
